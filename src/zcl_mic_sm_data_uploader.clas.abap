CLASS zcl_mic_sm_data_uploader DEFINITION
...
CLASS zcl_mic_sm_data_uploader IMPLEMENTATION.
...
select * from ZMIC_SM_BPA_ENTITY into table @data(itab).
...
*
*data : lt_bp type table of zmic_sm_bpa,
*
*lt_prod type table of zmic_sm_product.
*
*
*
*append value #(
...
*
*
*insert zmic_sm_bpa from table @lt_bp.
*
*insert zmic_sm_product from table @lt_prod.
*
*ENDMETHOD.
*
*
...
*
*lv_ord_id type zmic_sm_id,
*
*lt_so type table of zmic_sm_so_hdr,
*
*lt_so_i type table of zmic_sm_so_item.
*
*
*
...
*
*
*select * from zmic_sm_bpa into table @data(lt_bpa).
*
*select * from zmic_sm_product into table @data(lt_prod).
*
*
*
*do 50 times.
...
*
*
*insert zmic_sm_so_hdr from table @lt_so.
*
*insert zmic_sm_so_item from table @lt_so_i.
*
*
*
*ENDMETHOD.
...
*METHOD flush.
*
*delete from : zmic_sm_bpa, zmic_sm_product, zmic_sm_so_hdr, zmic_sm_so_item.
*
*ENDMETHOD.
*
*
