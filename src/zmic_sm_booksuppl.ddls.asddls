...
define view entity ZMIC_SM_BOOKSUPPL as select from /dmo/booksuppl_m 

association to parent ZMIC_SM_BOOKING as _Booking 

on $projection.TravelId = _Booking.TravelId and  

$projection.BookingId = _Booking.BookingId 

association[1..1] to ZMIC_SM_TRAVEL as _Travel  
